			...
			<div className="container">
				<div className="jumbotron">
					...
					<Switch>
						...
						<Route path="/comments" component={() => (<CommentsBox initialComments={this.props.initialComments} page={this.props.page} />)} />
						...
						<Route path="*" component={({ staticContext }) => { if (staticContext) staticContext.status = 404; return <h1>Not Found :(</h1>; }}/>
					</Switch>
				</div>
			</div>
		);
		if (typeof window === 'undefined') {
			return (<StaticRouter context={this.props.context} location={this.props.location}>{app}</StaticRouter>);
		}
